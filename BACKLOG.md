...
- **/market-insights/ data snapshot is stale (May 2026 read, found 2026-07-14).** The county stat cards (LA/OC/Riverside/San Bernardino/Irvine medians, DOM, inventory, the four headline numbers) are hand-authored from the May 2026 CAR/Redfin/PMMS reads; the page promises a regular cadence. Refresh the numbers from current sources (CAR monthly release, Redfin Data Center, Freddie PMMS via /api/rates) and bump the header date. Needs careful sourcing, not guesses; /prices/ and /rates/ hydrate live from FRED and are always current.
