...
# Two-section hero with a crystal-cove background. Page-specific copy and
      ...
      <ul class="d_flex flex-d_column gap_24px lg:gap_44px m_0 li-s_none p_0 mb_32px">
        ...
        <li class="d_flex ai_flex-start gap_16px">
          ...
          <div>
            ...
            <p class="c_#757575 fs_14px lg:fs_16px lh_21px lg:lh_24px m_0">Pro photos, copy, syndication, and a property landing page all live within 48 hours of signing.</p>
          </div>
        </li>
      </ul>
