...
def tier_section(tier: int, anchor: str) -> str:
    ...
    if tier == 2:
        extra_la_link = (
            ...
            '<a href="/los-angeles/" class="d_inline-flex ai_center jc_center bg_transparent c_#d92228 bd_1px_solid_#d92228 fw_700 fs_14px md:fs_15px ls_0.3px py_10px px_22px bdr_full hover:bg_#d92228 hover:c_#fff" style="text-decoration:none;">Read the full Los Angeles listing playbook &rarr;</a>'
            '</div>'
        )
    return f"""
      ...
      <ul class="d_flex flex-d_column gap_24px lg:gap_44px m_0 li-s_none p_0 mb_32px">
        ...
        <li class="d_flex ai_flex-start gap_16px">
          ...
          <div>
            ...
            <p class="c_#757575 fs_14px lg:fs_16px lh_21px lg:lh_24px m_0">Offers, escrow questions, timeline shifts all route through the same number. No call center, no junior on the file.</p>
          </div>
        </li>
      </ul>
