...
[white stat bar + #d3cfca divider]: `#drozq-commit-strip`, kicker "Hold me to these." over four big bold values with small red uppercase labels written to the seller's value equation, not the process ($0 to me until you close / 30 days sign to offers in hand / Zero showings or repairs to run / 3 for 3 closed early, on the board; Joshua 2026-08-25: "aim for what a home seller actually wants, do not hedge"), the activerealty.com/sell stat-row format per Joshua 2026-08-25; scoped CSS, 2x2 grid under 880px
