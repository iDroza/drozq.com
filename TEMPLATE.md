...
- **Conversion splash** (`/`, `/california/` giem-13, `/los-angeles/` giem-12, `/where-we-help/` giem-11): photo hero (full 100dvh splash on landers via the chrome block's `main>div:first-child` flex/min-height rules, per Joshua; 100dvh + rotation on the homepage), tabs + pill, Variant A header.
