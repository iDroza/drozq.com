...
- **Trust** (`/about/`: warm flat band into the portrait story; `/meet-the-team/` giem-16 thin band; `/testimonials/`: `.drozq-photo-band` giem-18 strip above the flat hero; `/contact/` giem-14 thin band + direct-contact cards above the fold): no pill in the splash, Variant B header.
