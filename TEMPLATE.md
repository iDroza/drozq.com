...
[white stat bar + #d3cfca divider]: `#drozq-commit-strip`, kicker "Hold me to these." over four big bold values with small red uppercase labels written to the seller's value equation, not the process ($0 out of pocket / 5 days listed to your first offer / Zero weekends lost to showings / 3 for 3 closed early, on the board; the $0 label and the 5-day line are Joshua's own wording; Joshua 2026-08-25: "aim for what a home seller actually wants, do not hedge"), the activerealty.com/sell stat-row format per Joshua 2026-08-25; scoped CSS, 2x2 grid under 880px
