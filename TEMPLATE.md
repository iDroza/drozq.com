...
- **Utility** (`/privacy/`, `/terms/`, `/thank-you/`, `/404.html`): unchanged layouts, Variant B header. `/thank-you/` keeps its "drop another address" pill (a second-lead play, not a splash CTA).
